...
import { Box, Typography, Card, CardMedia, Grid, Button, TextField } from "@mui/material"
...
const Film = props => {
    ...
    const btnHandle = () => {
        if((inputObj.adult === '' || inputObj.child === '')) {
            ...
            let name = user.name, phone = user.phoneNumber;
            ...
            setBool(bool.map((el, index) => index === (bool.length - 1) ? !el : el = false));
        ...
        >
            ...
            >
                <Grid item
                    sx={styles.gridItem}
                >
                    <CardMedia sx={styles.filmTicketsImage} src={filmVar.image} component="img"/>
                </Grid>
                <Grid item sx={styles.inputTicket}
                >
                    <Box 
                        xs={styles.inputOfBox}
                    >
                        <TextField 
                            id="outlined-basic" 
                            label="Том хүн..." 
                    ...
                    >
                        ...
                        >
                            <Button 
                                ...
                                name="date" 
                                onClick={(e => 
                                            setInputObj({...inputObj, [e.target.name]: e.target.textContent}))
                                        }>3/22/2022 2AM
                            </Button>
                        </Grid>
                        <Grid
